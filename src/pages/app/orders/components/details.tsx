              ...
              <Table>
                ...
                <Table.Body>
                  {order.orderItems.map((item) => (
                    <Table.Row key={item.id}>
                      ...
                      <Table.Cell className="text-right">{convertCurrency(item.priceInCents)}</Table.Cell>
                ...
                <Table.Footer>
                  <Table.Row>
                    ...
                    <Table.Cell className="text-right font-bold">{convertCurrency(order.totalInCents)}</Table.Cell>
                  </Table.Row>
                </Table.Footer>
              </Table>
            </div>
